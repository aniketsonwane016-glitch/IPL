...
//}
			...
			System.err.println("you have selected Options :"+input);
			...
			case 2:{
				System.out.println("Please enter your Fav TEam ShortName : ");
				String teamShortName =sc.next();
				System.out.println("enter Team Short NAme :"+teamShortName);
		...
		private void getTeamById(int id) {
			if(id==101) {
				...
				System.out.println("enetr a valid options :");
			}
		}
